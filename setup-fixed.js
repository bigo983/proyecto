...
fs.writeFileSync(path.join(baseDir, 'database', 'db.js'), dbCode);
...
fs.writeFileSync(path.join(baseDir, 'public', 'manifest.json'), JSON.stringify(manifest, null, 2));
...
fs.writeFileSync(path.join(baseDir, 'public', 'sw.js'), swCode);
...
fs.writeFileSync(path.join(baseDir, 'public', 'index.html'), htmlCode);
...
fs.writeFileSync(path.join(baseDir, 'run.bat'), batCode);
